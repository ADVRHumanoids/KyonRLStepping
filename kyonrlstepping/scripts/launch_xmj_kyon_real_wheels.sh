...
VARIANT_NAME="kyon_real_wheels_no_yaw"
...
XBOT_CONFIG_SRC="${KYON_XBOT_CONFIG_SRC:-${KYON_XMJ_DIR}/xbot2_basic_wheels_no_yaw_real.yaml}"
SIMOPT_PATH="${KYON_SIMOPT_PATH:-${KYON_XMJ_DIR}/sim_opt_wheels.xml}"
XBOT_CONFIG_BUILDER="${IBRIDO_XBOT_CONFIG_BUILDER:-${HOME}/ibrido_utils/ibrido_xbot_config_builder.py}"
KYON_JNT_IMP_CONFIG_PATH="${KYON_JNT_IMP_CONFIG_PATH:-${HOME}/ibrido_ws/src/KyonRLStepping/kyonrlstepping/config/jnt_imp_config_kyon_real_no_yaw.yaml}"
...
cfg = Path(sys.argv[1])
text = cfg.read_text()
text = text.replace("urdf_path: $PWD/kyon_real_wheels_no_yaw.urdf", "urdf_path: " + sys.argv[2])
text = text.replace("srdf_path: $PWD/kyon_real_wheels_no_yaw.srdf", "srdf_path: " + sys.argv[3])
