from kyonrlstepping.controllers.horizon_based.kyon_rhc_cluster_client import KyonRHCLusterClient
...
if __name__ == "__main__":  
    ...
    control_cluster_client = KyonRHCLusterClient(namespace=namespace, 
                                        ...
                                        robot_pkg_pref_path=args.robot_pkg_pref_path) # this blocks until connection with the client is established
